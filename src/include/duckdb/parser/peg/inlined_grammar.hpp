...
const char INLINED_PEG_GRAMMAR[] = {
	...
	"CreateFeatureStmt <- 'FEATURE' IfNotExists? IdentifierOrStringLiteral 'ON' IdentifierOrStringLiteral FeatureEntityClause? 'TIMESTAMP' IdentifierOrStringLiteral FeatureGranularityClause? FeatureWindowClause? FeatureRefreshClause? FeatureRetainClause? 'AS' Parens(SelectStatementInternal)\n"
	...
	"ServeFeatureEntity <- 'ENTITY' FeatureEntitySpec\n"
